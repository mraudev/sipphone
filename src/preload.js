...
contextBridge.exposeInMainWorld('phone', {
  ...
  exportBackup: (password) => ipcRenderer.invoke('phone:exportBackup', password),
  chooseBackup: () => ipcRenderer.invoke('phone:chooseBackup'),
  importBackup: (password) => ipcRenderer.invoke('phone:importBackup', password),
